          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <?php
                ...
                $stmt = $pdo->prepare("SELECT * FROM sales_order_details WHERE sale_order_id=".$_GET['id']);
                $stmt->execute();
                $rawResult = $stmt->fetchAll();

                $total_pages = ceil(count($rawResult) / $numOfrecs);

                $stmt = $pdo->prepare("SELECT * FROM sales_order_details WHERE sale_order_id=".$_GET['id']." LIMIT $offset,$numOfrecs");
                $stmt->execute();
